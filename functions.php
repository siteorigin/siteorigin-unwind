...
function siteorigin_unwind_scripts() {
	...
	if ( ( is_home() && siteorigin_setting( 'blog_featured_slider' ) && siteorigin_unwind_has_featured_posts() ) || ( is_single() && has_post_format( 'gallery' ) ) || ( siteorigin_setting( 'woocommerce_display_quick_view' ) && is_shop() ) ) {
